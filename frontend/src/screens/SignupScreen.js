...
const SignupScreen = () => {
  ...
  const handleSignUp = () => {
    ...
    // return;
    if (!firstName || !lastName || !roll || !rollNumber || !password || !email) {
      setAlert("Please Fill in the form first")
    }

    dispatch(studentSignup({ firstName, lastName, rollNumber, email, password, roll }));
    window.scrollTo(0, 0);
  };
  ...
  return (
    <>
      <div className="flex flex-col min-h-screen w-full h-fit">
        ...
        {alert && <Alert status='error' w="80%" className='m-auto z-[1000] top-10'>
            ...
            <div className="form mt-[50px]">
              <div className="flex flex-col items-center gap-x-2">
                ...
                <div className="w-full text-left my-2">
                  <label className="text-base1 font-normal block mb-1" htmlFor="firstName">
                    first Name
                  </label>
                  <input
                    name="firstName"
                ...
                {/* Last name */}
                <div className="w-full text-left my-2">
                  <label className="text-base1 font-normal block mb-1" htmlFor="lastName">
                    Last Name
                  </label>
                  <input
                    name="lastName"
                ...
                <div className="w-full text-left my-2">
                  <label className="text-base1 font-normal block mb-1" htmlFor="rollNumber">
                    Roll NUmber
                  </label>
                  <input
                    name="rollNumber"
                ...
                {/* email */}
                <div className="w-full text-left my-2">
                  <label className="text-base1 font-normal block mb-1" htmlFor="email">
                    Email
                  </label>
                  <input
                    name="email"
                ...
                {/* password */}
                <div className="w-full text-left my-2">
                  <label className="text-base1 font-normal block mb-1" htmlFor="password">
                    Password
                  </label>
                  <input
                    name="password"
              ...
              >
                ...
                >
                  {loading ? <CircularProgress color="inherit" className="mr-10" size={'20px'} /> : "Sign Up"}
                </p>
              </button>
              {/* </form> */}
            </div>
